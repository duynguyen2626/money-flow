...
import { MemberDetailView } from '../[id]/details/member-detail-view'
...
export default async function MemberDetailsPage({ searchParams }: PageProps) {
    const params = await searchParams
    const personId = params.ids
