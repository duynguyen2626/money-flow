    ...
    return (
        <div className={cn("flex items-center justify-between gap-2 w-full", className)}>
            ...
            <div className="flex items-center gap-3 flex-1 min-w-0">
                <Link href={`/accounts/${transaction.account_id}/details`} target="_blank" className="shrink-0">
                    {sourceImg ? (
                        <img
                            src={sourceImg}
                            alt={sourceName}
                ...
                <div className="flex flex-col min-w-0 items-start">
                    <Link href={`/accounts/${transaction.account_id}/details`} target="_blank" className="hover:underline">
